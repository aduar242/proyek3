            ...
            <div class="card-body"><h5 class="card-title">Controls Types</h5>
                <form action="<?php echo e(route('client.update', $pakets->id)); ?>"  method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="_method" value="POST">
                        <div class="position-relative form-group"><label for="exampleNama" class="">Nama</label><input name="nama" id="exampleNama" value="<?php echo e($pakets->nama); ?>" type="string" class="form-control <?php echo e($errors->has('nama') ? 'is-invalid':''); ?>"></div>
                        <div class="position-relative form-group"><label for="exampleHarga" class="">Harga</label><input name="harga" id="exampleNama" value="<?php echo e($pakets->harga); ?>" type="number" class="form-control <?php echo e($errors->has('harga') ? 'is-invalid':''); ?>"></div>
